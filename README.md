# Using History API in ASP.NET MVC [![Build status](https://ci.appveyor.com/api/projects/status/5h7tfwagjda4efy8?svg=true)](https://ci.appveyor.com/project/skazantsev/aspnethistoryapi)
